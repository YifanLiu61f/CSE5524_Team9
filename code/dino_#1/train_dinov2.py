...
def parse_args():
    ...
    p.add_argument("--train-csv", default="train_annotations.csv")
...
def main():
    ...
    tf_train = transforms.Compose([
        transforms.RandomResizedCrop((proc.crop_size["height"], proc.crop_size["width"]), scale=(0.8, 1.0)),
    ...
    model = AutoModelForImageClassification.from_pretrained(
        args.model_id, num_labels=len(ds.cat2idx)
    ).to(device)
